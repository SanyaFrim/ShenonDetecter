...
// StringAnalyzerMFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CStringAnalyzerMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CStringAnalyzerMFCApp

CStringAnalyzerMFCApp::CStringAnalyzerMFCApp()
{
...
// Единственный объект CStringAnalyzerMFCApp

CStringAnalyzerMFCApp theApp;


// Инициализация CStringAnalyzerMFCApp

BOOL CStringAnalyzerMFCApp::InitInstance()
{
